<!-- navbar start -->
<nav class="navbar navbar-expand-md navbar-light hidden-print sticky-top">
  ...
  <div class="container-fluid">
    ...
    <div>
      ...
      <span class="text-white text-uppercase fw-bold"><?= $_SESSION['office-role'] ?></span>

    </div>

    <?php
    if (isset($_SESSION["office-role"])) { ?>

      <div class="ms-auto dropdown">

        <button type="button" class="btn text-white dropdown-toggle" data-bs-toggle="dropdown"><?php echo $_SESSION["office-fullname"]; ?></button>

        <ul class="dropdown-menu dropdown-menu-end">

          <li class="dropdown-item"><a href="new-password.php" class="nav-link text-muted">Change Password</a></li>
