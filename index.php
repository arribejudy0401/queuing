        ...
        <div class="m-2">
          ...
          <div class="d-flex">
            ...
            <div class="dropdown  form-control p-2 rounded mb-2">
              ...
              <ul class="dropdown-menu">
                ...
                ?>
                  <li class="dropdown-item"><a href="index.php?status=new&office=<?= $_GET['office'] ?>" class="nav-link text-muted">New Visitor</a></li>

                  <li class="dropdown-item"><a href="index.php?status=old&office=<?= $_GET['office'] ?>" class="nav-link text-muted">Student</a></li>

                <?php
                } else { ?>

                  <li class="dropdown-item"><a href="index.php?status=new" class="nav-link text-muted">New Visitor</a></li>

                  <li class="dropdown-item"><a href="index.php?status=old" class="nav-link text-muted">Student</a></li>
              ...
              <ul class="dropdown-menu">
                ...
                ?>
                  ...
                  <li class="dropdown-item">
                    ...
                    ?>
                      <a href="index.php?status=<?= $_GET['status'] ?>&office=<?= $row['office_name'] ?>" class="nav-link text-muted"><?= $row['office_name'] ?></a>

                    <?php
                    } else { ?>
                      <a href="index.php?office=<?= $row['office_name'] ?>" class="nav-link text-muted"><?= $row['office_name'] ?></a>
          ...
          if (isset($_GET['status'])) {
            ...
            if ($status === 'new') {
             ...
             <input type='email' name='student-email' id='' class='form-control mb-2 ' placeholder='Enter Your Email' required>
             </div>
             ...
             <p></p>
              ...
              <input type='number' name='student-email' id='' class='form-control mb-2 ' placeholder='Enter Your Student Number:' required>
          ...
          <div class="d-flex input-group">
            ...
            <input type="text" name="student-firstname" id="" class="form-control mb-2 rounded" placeholder="Firstname" required>

            <input type="text" name="student-middlename" id="" class="form-control mb-2 rounded mx-2" placeholder="Middlename">

            <p></p>
            <input type="text" name="student-lastname" id="" class="form-control mb-2 rounded" placeholder="Lastname" required>
          ...
          ?>
            <button type="submit" id="" name="reservation-btn" class="m-2 btn d-block btn-bg-main btn-bg-main-hover w-100 m-auto mt-2">Submit</button>
